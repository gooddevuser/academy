                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">강사 신청</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="add-professor" class="dropzone dropzone-custom needsclick add-professors" id="Add-professorForm" method="post">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light" id="add-professorbtn">신청하기</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
...
<script type="text/javascript">
	$(function() {
		...
		$('#add-professorbtn').on('click', function(event) {
			//1. 유효성 검사
			if ($('#name').val() == '') {
				alert('이름을 입력하세요');
				$('#name').focus();
