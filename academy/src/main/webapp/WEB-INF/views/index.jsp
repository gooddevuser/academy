                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>컴퓨터 기술</h5>
                                <h2><span class="counter">5000</span> <span class="tuition-fees">강의료</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>회계 기술</h5>
                                <h2><span class="counter">3000</span> <span class="tuition-fees">강의료</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>전기 공학</h5>
                                <h2><span class="counter">2000</span> <span class="tuition-fees">강의료</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>화학 공학</h5>
                                <h2>$<span class="counter">3500</span> <span class="tuition-fees">강의료</span></h2>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-sales-chart">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>아카데미 수입</b></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="actions graph-rp graph-rp-dl">
                                            <p>모든 수입은 천만원 기준입니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <ul class="list-inline cus-product-sl-rp">
                                <li>
                                    <h5><i class="fa fa-circle" style="color: #006DF0;"></i>컴퓨터</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle" style="color: #933EC5;"></i>회계</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle" style="color: #65b12d;"></i>전기공학</h5>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><img src="/academy/resources/img/product/profile-bg.jpg" alt=""></a>
                            </div>
                            <div class="single-product-text">
                                <img src="/academy/resources/img/product/pro4.jpg" alt="">
                                <h4><a class="cards-hd-dn" href="#">안젤라 도미니크</a></h4>
                                <h5>웹디자이너 및 개발자</h5>
                                <p class="ctn-cards">안녕하세요 안젤라 도미니크 입니다.</p>
                                <a class="follow-cards" href="#">팔로우</a>
                                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="/academy/resources/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="/academy/resources/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>그레이브스</h3>
                                    <p>멋집니다.</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/academy/resources/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>고베 트로프로</h3>
                                    <p>좋은 웹사이트입니다.</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/academy/resources/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>시암 그레이브스</h3>
                                    <p>잘 만들어졌습니다.</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/academy/resources/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>사라 그레이브스</h3>
                                    <p>매우 추천합니다.</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/academy/resources/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>줄샤 그라브</h3>
                                    <p>안녕하세요</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="/academy/resources/img/product/book-4.jpg" alt=""></a>
                            </div>
                            <div class="single-product-text edu-pro-tx">
                                ...
                                <div class="product-buttons">
                                    <button type="button" class="button-default cart-btn">더 보러가기</button>
