                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="latest-blog-single blog-single-full-view">
                                        <div class="blog-image">
                                            ...
                                            <div class="blog-date">
                                                <p><span class="blog-day">${ course.year }</span> ${ course.duration }</p>
                                            </div>
                                        </div>
                                        <div class="blog-details blog-sig-details">
                                            <div class="details-blog-dt blog-sig-details-dt courses-info mobile-sm-d-n">
                                                <span><a href="#"><i class="fa fa-user"></i> <b>강의 제목:</b>${ course.name }</a></span>
                                                <span><a href="#"><i class="fa fa-heart"></i> <b>강의 금액:</b>${ course.price }</a></span>
                                                <span><a href="#"><i class="fa fa-comments-o"></i> <b>강사 성함:</b>${ course.professor }</a></span>
                                            </div>
